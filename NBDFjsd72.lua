...
queueonteleport('https://raw.githubusercontent.com/TpaBaBpyKe/Nai23hiVgF4hSS/main/NBDFjsd72.lua')
local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/TpaBaBpyKe/yessir/main/NAbd734BS6S.lua"))()
...
local sHopSwitch = otherTab:AddSwitch('Смена сервера после доната',function(bool)
	getgenv().settings.serverHopAfterDonation = bool
	saveSettings()
end)

local jumpsPerRB = otherTab:AddSlider("Прыжок за робукс", function(x)
	if settingsLock then
		return
	end
